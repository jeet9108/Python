...
btn_wp = Button(sidebar, text="Working Papers", bg="white", font=("Arial Black", 12), width=20,command=open_workingpapers)
btn_wp.pack(pady=5)

btn_user_mgmt = Button(sidebar, text="User Management", bg="white", font=("Arial Black", 12), width=20,command=open_usermanage)
btn_user_mgmt.pack(pady=5)

btn_db = Button(sidebar, text="Database Manager", bg="white", font=("Arial Black", 12), width=20,command=open_database)
btn_db.pack(pady=5)
